...
public record CoupleCourseFolderResponseDto(
    ...
    public static CoupleCourseFolderResponseDto from(Course course, int commentCount) {
        return new CoupleCourseFolderResponseDto(
                course.getId(),
