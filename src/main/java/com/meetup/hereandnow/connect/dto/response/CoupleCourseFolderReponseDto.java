...
public record CoupleCourseFolderReponseDto(
    ...
    public static CoupleCourseFolderReponseDto from(Course course, int commentCount) {
        return new CoupleCourseFolderReponseDto(
                course.getId(),
